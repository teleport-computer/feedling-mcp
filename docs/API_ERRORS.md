...
| `vision_resident_update_required` | 409 | user_environment | 已选专用视觉路由，但当前 V1/VPS resident 未上报 `vision_observer_v1`；消息尚未落库 | ✅ |
| `vision_model_required` | 409 | user_provider | 图片发送前没有已验证可用的视觉路由；消息尚未落库 | ✅ |
