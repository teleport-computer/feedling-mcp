...
from a system prompt, last-known-good MEMORY/STYLE profile fields, a bounded
...
_RUNTIME_TEMPORAL_PROTOCOL_POLICY = (
    ...
    "tail_timestamps[].index 在紧邻它的逐字对话尾部中从 0 起算；应用数据块"
...
_RUNTIME_MEMORY_PROTOCOL_POLICY = (
    ...
    f"'{USER_PROFILE_HEADER.splitlines()[0]}' 的块。"
)
