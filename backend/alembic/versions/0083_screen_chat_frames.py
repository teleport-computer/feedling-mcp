"""Durable screen-chat cursor and frame/cache metrics.

Revision ID: 0083_screen_chat_frames
"""

from alembic import op


revision = "0083_screen_chat_frames"
down_revision = "0082_merge_image_voice"
branch_labels = None
depends_on = None
