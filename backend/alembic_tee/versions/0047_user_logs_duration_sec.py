...
Revision ID: 0047_user_logs_duration_sec
Revises: 0046_memory_vectors

TEE twin of alembic 0112_user_logs_duration_sec; DDL is identical.
...
revision = "0047_user_logs_duration_sec"
down_revision = "0046_memory_vectors"
branch_labels = None
depends_on = None
...
_UPDATE_PREPARED_HEAD = """UPDATE server_config SET value=convert_to(
        ...
        '["0047_user_logs_duration_sec"]'::jsonb)::text, 'UTF8')
