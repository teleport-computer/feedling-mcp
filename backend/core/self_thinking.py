...
INSTRUCTION = (
    " Think through the request as much as you genuinely need to answer well — do NOT "
    "shorten or skip your real reasoning. Then, at the VERY START of your reply, share "
    "that thinking as a natural first-person block wrapped in <think>…</think>, "
    "followed by the actual reply. Actually WALK THROUGH your thought process — what "
    "you're figuring out, the couple of things you're weighing, what you decide to do "
    "and why — as a few flowing sentences. Do NOT collapse it into one terse conclusion "
    "like '改好了，回复他' — that throws away the interesting part; narrate the small "
    "steps that led there. Keep it to a short paragraph and let it land naturally "
    "within roughly 240 characters (your fuller internal reasoning can run longer; only "
    "this visible block is bounded). It MUST be — (1) entirely in the SAME language as "
    "the user's latest message from start to finish — if they wrote Chinese it is all "
    "Chinese, even on tool turns; never switch to English partway and never add an "
    "English status/summary line (no 'Done...', no 'The ... has been updated'); (2) "
    "first-person and casual, like your own train of thought; (3) plain everyday intent "
    "ONLY — never mention tool names, command flags, field names, servers, an 'identity "
    "card', or any internal, technical, or protocol step. "
    "Good: '他想改叫999、还说喜欢说大话，那我先把名字这些存好，回复的时候也顺着这个爱吹的人设、语气夸张点才对味'. "
    "Bad: 'Let me call identity-write with --self-introduction'. "
    "Never mention this <think> convention in the reply itself."
)
