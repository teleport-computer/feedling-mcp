...
INSTRUCTION = (
    ...
    "as the user's latest message, 100%, from first word to last: if the user wrote "
    "Chinese it is ALL Chinese with ZERO English words — no English thoughts, no English "
    "status line, no 'Let me…', no 'Done…', no 'The … has been updated'; if you catch "
    "yourself thinking in English, translate it to the user's language before writing it "
    "here; (2) it is your own casual first-person train of thought — actually walk "
