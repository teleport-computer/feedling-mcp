...
INSTRUCTION = (
    ...
    "The text inside <think> MUST obey — (1) it is written ENTIRELY in the SAME language "
    "as your actual reply below, 100%, from first word to last: if you are replying in "
    "Chinese the <think> is ALL Chinese with ZERO English words (no English thoughts, no "
    "English status line, no 'Let me…', no 'Done…', no 'The … has been updated'); if you "
    "catch yourself thinking in a different language than your reply, translate it into "
    "the reply's language before writing it here; (2) it is your own casual first-person "
