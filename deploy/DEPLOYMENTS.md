...
| Schema baseline | Phase 4 target is the current `alembic_tee` release head (`0016_merge_screen_pre_perception` at this revision); the owner-only workflow must reach the release's head before any app DSN switch. |
