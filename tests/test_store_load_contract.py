...
SHELL_ONLY_GET_STORE_SITES: dict[tuple[str, int], str] = {
    ...
    ("backend/model_api_runtime/v2/worker.py", 8603): "wake lane reads bounded DB inputs and durable cursors",
    ("backend/model_api_runtime/v2/worker.py", 13386): "chat lane reads bounded DB inputs and durable cursors",
