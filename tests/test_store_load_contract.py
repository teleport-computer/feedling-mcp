...
SHELL_ONLY_GET_STORE_SITES: dict[tuple[str, int], str] = {
    ...
    ("backend/model_api_runtime/v2/jobs_store.py", 4307): "terminal reply is a cold-safe committed write",
    ...
    ("backend/model_api_runtime/v2/serve_worker.py", 1406): "memory quoted-card reads are DB/readside backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 1763): "summary envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 1822): "checkpoint envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 1864): "wake gate state uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 1894): "scheduled wake control is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 2038): "image capability reads exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 2140): "screen decrypt reads an exact frame row",
    ("backend/model_api_runtime/v2/serve_worker.py", 2464): "file capability reads exact DB/object rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 2672): "image generation output is a cold-safe write",
    ("backend/model_api_runtime/v2/serve_worker.py", 2860): "profile memory reads use DB/readside helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 2956): "turn memory reads use DB/readside helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 3119): "memory actions use durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 3182): "memory envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 3197): "capture scheduler state is DB/blob backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3228): "dream scheduler state is DB/blob backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3324): "screen-watch runtime fence is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3587): "reply effect is a cold-safe committed write",
    ("backend/model_api_runtime/v2/serve_worker.py", 3601): "legacy reply effect is a cold-safe committed write",
    ("backend/model_api_runtime/v2/serve_worker.py", 3625): "transactional reply uses cold-safe post-commit reconciliation",
    ("backend/model_api_runtime/v2/serve_worker.py", 3910): "identity capability uses durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4005): "schedule capability uses durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4059): "workspace capability uses exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 4141): "workspace batch capability uses exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 4659): "trajectory envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 4708): "capture state is a direct blob read",
    ("backend/model_api_runtime/v2/serve_worker.py", 4750): "dream status uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4780): "capture status uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4989): "debug trace is a durable log write",
    ("backend/model_api_runtime/v2/serve_worker.py", 5048): "runtime mode dependency is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 5057): "web-tools setting is a direct blob read",
    ("backend/model_api_runtime/v2/serve_worker.py", 5132): "scheduler runtime mode is DB-backed",
    ("backend/model_api_runtime/v2/worker.py", 8604): "wake lane reads bounded DB inputs and durable cursors",
    ("backend/model_api_runtime/v2/worker.py", 13387): "chat lane reads bounded DB inputs and durable cursors",
