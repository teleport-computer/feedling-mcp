...
SHELL_ONLY_GET_STORE_SITES: dict[tuple[str, int], str] = {
    ...
    ("backend/model_api_runtime/v2/jobs_store.py", 4330): "terminal reply is a cold-safe committed write",
    ...
    ("backend/model_api_runtime/v2/serve_worker.py", 1787): "summary envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 1846): "checkpoint envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 1888): "wake gate state uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 1918): "scheduled wake control is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 2062): "image capability reads exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 2164): "screen decrypt reads an exact frame row",
    ("backend/model_api_runtime/v2/serve_worker.py", 2488): "file capability reads exact DB/object rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 2696): "image generation output is a cold-safe write",
    ("backend/model_api_runtime/v2/serve_worker.py", 2884): "profile memory reads use DB/readside helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 2980): "turn memory reads use DB/readside helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 3143): "memory actions use durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 3206): "memory envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 3221): "capture scheduler state is DB/blob backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3252): "dream scheduler state is DB/blob backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3348): "screen-watch runtime fence is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 3611): "reply effect is a cold-safe committed write",
    ("backend/model_api_runtime/v2/serve_worker.py", 3625): "legacy reply effect is a cold-safe committed write",
    ("backend/model_api_runtime/v2/serve_worker.py", 3649): "transactional reply uses cold-safe post-commit reconciliation",
    ("backend/model_api_runtime/v2/serve_worker.py", 3934): "identity capability uses durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4029): "schedule capability uses durable helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4083): "workspace capability uses exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 4165): "workspace batch capability uses exact DB rows",
    ("backend/model_api_runtime/v2/serve_worker.py", 4683): "trajectory envelope construction needs identity only",
    ("backend/model_api_runtime/v2/serve_worker.py", 4732): "capture state is a direct blob read",
    ("backend/model_api_runtime/v2/serve_worker.py", 4774): "dream status uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 4804): "capture status uses direct DB/blob helpers",
    ("backend/model_api_runtime/v2/serve_worker.py", 5013): "debug trace is a durable log write",
    ("backend/model_api_runtime/v2/serve_worker.py", 5072): "runtime mode dependency is DB-backed",
    ("backend/model_api_runtime/v2/serve_worker.py", 5081): "web-tools setting is a direct blob read",
    ("backend/model_api_runtime/v2/serve_worker.py", 5156): "scheduler runtime mode is DB-backed",
    ("backend/model_api_runtime/v2/worker.py", 8694): "wake lane reads bounded DB inputs and durable cursors",
    ("backend/model_api_runtime/v2/worker.py", 13481): "chat lane reads bounded DB inputs and durable cursors",
