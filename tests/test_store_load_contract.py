...
SHELL_ONLY_GET_STORE_SITES: dict[tuple[str, int], str] = {
    ...
    ("backend/model_api_runtime/v2/jobs_store.py", 4329): "terminal reply is a cold-safe committed write",
    ...
    ("backend/model_api_runtime/v2/worker.py", 8681): "wake lane reads bounded DB inputs and durable cursors",
    ("backend/model_api_runtime/v2/worker.py", 13468): "chat lane reads bounded DB inputs and durable cursors",
