...
SHELL_ONLY_GET_STORE_SITES: dict[tuple[str, int], str] = {
    ...
    ("backend/model_api_runtime/v2/worker.py", 8883): "wake lane reads bounded DB inputs and durable cursors",
    ("backend/model_api_runtime/v2/worker.py", 13700): "chat lane reads bounded DB inputs and durable cursors",
