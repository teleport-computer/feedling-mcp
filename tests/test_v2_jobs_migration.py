...
def test_agent_jobs_chain_has_one_installed_head_and_available_at_baseline():
    ...
    assert heads == ["0098_contract_rejection_stats"]
    assert (script.get_revision("0098_contract_rejection_stats").down_revision
...
def test_perception_signal_schema_is_installed_at_the_merged_head():
    ...
    assert installed_head == ("0098_contract_rejection_stats",)
